...
REM "%JAVA_HOME%"\bin\java -Xmx16g -Xms16g -XX:+UnlockCommercialFeatures  -XX:+FlightRecorder -XX:FlightRecorderOptions=defaultrecording=true,dumponexit=true  -cp .\target\benchmarks.jar com.netcracker.util.Main
